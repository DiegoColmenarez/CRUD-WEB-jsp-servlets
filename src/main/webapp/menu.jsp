...
<div class="container">
    ...
    <div class="menu-grid">
        ...
        <a href="${pageContext.request.contextPath}/search" class="menu-item">Modificar Usuario</a>
        <a href="${pageContext.request.contextPath}/search" class="menu-item">Eliminar Usuario</a>
