...
public class EmailService {
    ...
    static {
        ...
        String localFrom = PropertiesLoaderSmtp.get("smtp.from") != null ? PropertiesLoaderSmtp.get("smtp.from") : SMTP_USER;
        SMTP_FROM = (envFrom != null && !envFrom.isEmpty()) ? envFrom : localFrom;
